...
<body>
  ...
  <div class="mb-5 w-75">
    ...
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" width="50%" placeholder="Email"> 
  ...
  <button type="submit" class="orientationBtn btn btn-primary">Submit</button>
</form>
